...
public class Tab3Fragment extends BaseFragment {
    ...
    private class StationAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(Tab3Fragment.this.getContext(), R.layout.station_item, null);
    ...
    private class FactorAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(Tab3Fragment.this.getContext(), R.layout.factor_item, null);
