...
public class GuidePageActivity extends FragmentActivity {
    ...
    class GuidePageFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater,
            ...
            if(index==1){
                mRl.setBackgroundResource(R.drawable.gdpage1);
            }else if(index==2){
                mRl.setBackgroundResource(R.drawable.gdpage2);
            }else if(index==3){
                mRl.setBackgroundResource(R.drawable.gdpage3);
            }else{
                mRl.setBackgroundResource(R.drawable.gdpage4);
                btn.setVisibility(View.VISIBLE);
                btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View arg0) {
                        Intent intent=new Intent(getActivity(), LoginActivity.class);
                        smartGreenApp.setisFirst(false);
