...
import com.example.wyq.huizhi.Common.LocalImageHolderView;
import com.example.wyq.huizhi.Common.NetworkImageHolderView;
 ...
 */
public class RealTimeFragment extends Fragment implements AdapterView.OnItemClickListener, ViewPager.OnPageChangeListener, OnItemClickListener {
    View view;
...
//        convenientBanner.notifyDataSetChanged();
    ...
    public void onPageSelected(int position) {
        Toast.makeText(this.getContext(),"监听到翻到第"+position+"了", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onItemClick(int position) {
        Toast.makeText(this.getContext(),"点击了第"+position+"个",Toast.LENGTH_SHORT).show();
    }
}
