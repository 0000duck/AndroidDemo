    ...
    {        
        ...
        public static Boolean TryDump(String dmpPath, MiniDumpType dmpType)
        {
            ...
            using (FileStream stream = new FileStream(path, FileMode.Create))
            {
                ...
                mei.ThreadId = System.AppDomain.GetCurrentThreadId();//only this can generate full imformation,fuck ms//System.Threading.Thread.CurrentThread.ManagedThreadId;//System.AppDomain.GetCurrentThreadId();//Thread.CurrentThread.ManagedThreadId;
