...
{
    public partial class ExFileWritePageFrm : Basefm
    {
        private byte[] addrc;
        
        public ExFileWritePageFrm()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            addrc = ci.GetWriteToPageCmd(hiAddr, loAddr);
        ...
        public override void OnRecvData(byte[] datas)
        {
            ...
            if(recv == "0xEE 0x04 0x01 0xDA 0xDF")
            {
                richTextBox2.Text = "写1部分成功！/r/n";
            }
            else if(recv == "0xEE 0x05 0x01 0xDA 0xED 0x33")
            {
