...
{
    public partial class MoveVrateToAxis : Basefm
    {
        private byte[] addrc;
        
        public MoveVrateToAxis()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            addrc = ci.GetVrateToAxisCmd(commandAddr, textBox1.Text,textBox2.Text,textBox4.Text, textBox3.Text);
