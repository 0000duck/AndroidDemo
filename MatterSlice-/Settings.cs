...
namespace MatterHackers.MatterSlice
{
	...
	public class ConfigSettings
	{
		...
		public void SetToDefault()
		{
            ...
            firstLayerThickness = .1;//default is .3;
			layerThickness = 0.1;//厚度，默认是 .1.可以改成0.01
			firstLayerExtrusionWidth = .8;
            extrusionWidth = 0.1;//默认是 .4;内外层的厚度。
			supportExtrusionPercent = 100;
            numberOfPerimeters = 2;//默认是 2;几层外壁。
			...
			// raft settings
			enableRaft = false;
            raftAirGap = 0.1;//.2; // .2 mm for .4 mm nozzle
