...
namespace Web.Demo.Areas.DKLManager.Controllers
{
    public class ParameterController : AdminControllerBase
    {
        ...
        {
            var result = this.IDKLManagerService.GetParameterListAll(request);
            return View(result);
        }
        public ActionResult Create()
        {
            var model = new Parameter();
            ViewData.Add("SampleType", new SelectList(EnumHelper.GetItemValueList<EnumSampleType>(), "Key", "Value"));
