...
{
    public class ProjectTechnologyControlController : AdminControllerBase
    {
        ...
        public ActionResult Index(ProjectInfoRequest request)
        {
            ...
            request.ProjectStatus = (int)EnumProjectSatus.TechnicalPerson;
        ...
        {
            var users = this.AccountService.GetUserList(20);
        ...
        public ActionResult Submit(int id, FormCollection collection)
        {
            ...
            if (model.projectBasicinfo != null)
            {
               ...
               // model.projectBasicinfo.Person = model.projectBasicinfo.ProjectCheif;
                this.IDKLManagerService.UpdateProjectInfo(model.projectBasicinfo);
            }
            return this.RefreshParent();
        }
