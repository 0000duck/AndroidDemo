...
{
    public class ZPThressCheckController : AdminControllerBase
    {
        public static ProjectInfo UploadModel = new ProjectInfo();
        //
        // GET: /DKLManager/ZPThressCheck/
        public ActionResult Index(ProjectInfoRequest request)
        {
            request.ProjectStatus = (int)EnumProjectSatus.PersonW;
        ...
        public ActionResult CheckDoc(int id)
        {
            ...
            var users = this.AccountService.GetUserList(4).Select(c => new { Id = c.ID, Name = c.Name });
