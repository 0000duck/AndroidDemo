...
{
    public class AuthorizationPersonController : SampleBaseController
    {
        ...
        //
        // GET: /DKLManager/AuthorizationPerson/
        public ActionResult Index(ProjectInfoRequest request)
        {
            ...
            request.SampleStates = (int)EnumSampleStates.SysCheck;
        ...
        public ActionResult Check(int id, FormCollection collection)
        {
            ...
            //model.SampleStates = (int)EnumSampleStates.ThreeCheck;
            //this.IDKLManagerService.UpDateSampleRegister(model);
        ...
        public ActionResult UpdateAlls(ProjectInfoRequest request, FormCollection collection, List<int> ids)
        {
            ...
            if (ids != null)
            {
                foreach (var item in ids)
                {
                    ...
                    temp.SampleStates = (int)EnumSampleStates.ThreeCheck;
