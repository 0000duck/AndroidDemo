...
namespace OfficeDocGenerate
{
    public class CreateWater
    {
        ...
        public CreateWater(Costing model)
        {
            this.model = model;
        }
        ...
        {
            string fileName = "";
            string name = "水质项目成本分析表" + DateTime.Now.ToFileTime();
            ...
            string documentFile = m_utils.File.Combine(path, "水质项目成本分析表", Word.Tools.DocumentFormat.Normal);
