...
{
    //职业病危害控制效果评价评价
    public class CreateContractControlResultEvaluation
    {
        ProjectContract model;
        string Header = "合同编号：                                 DKL/QB-11-05                      职业病危害控制效果评价 ";
        ...
        public CreateContractControlResultEvaluation(ProjectContract Model)
        {
            this.model = Model;
