...
namespace OfficeDocGenerate                                                         //职业病危害现状评价
{
    public class CreateContractHazardAssessment
    {
        ...
        public CreateContractHazardAssessment(ProjectContract Model)
        {
            this.model = Model;
            // start word and turn off msg boxes
            this.Header = "ProjectNumber" + "                   DKL/QB-28-02                     "; ;
        }
        ...
        private void WriteFirstPage(string reportNum, string company, string reportDate)
        {
            ...
            for (int i = 0; i < 7; ++i)
                m_wordApp.Selection.TypeText("\r\n");
            m_wordApp.Selection.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
            m_wordApp.Selection.TypeText("\r\n项目名称：" + model.CompaneName + "新建" + model.ProjectName + "建设项目职业病危害现状评价");
        ...
        private void WriteInstruction()
        {
            ...
            m_wordApp.Selection.Font.Bold = 0;
            m_wordApp.Selection.TypeText("本合同由"+model.CompaneName+"（下称甲方）委托北京德康莱健康安全科技股份有限公司（下称乙方）就"+model.CompaneName+"有限公司新建"+model.ProjectName+"建设项目开展职业病危害现状评价技术服务工作。甲方获得乙方提供的符合国家《职业病防治法》及相关规范的该项目职业病危害现状评价报告书，向安监部门备案、评审。双方经过平等协商，根据《中华人民共和国合同法》的规定，达成以下协议，并由双方共同恪守。");
            ...
            m_wordApp.Selection.TypeParagraph();
            m_wordApp.Selection.TypeText("1.1“合同” 是指由甲方与乙方签订的"+model.CompaneName+"新建"+model.ProjectName+"建设项目职业病危害现状评价技术服务合同，包括合同条款、相关附件以及在合同履行期间双方可能签订的备忘录和/或变更单。");
            m_wordApp.Selection.TypeParagraph();
            m_wordApp.Selection.TypeText("1.2“报告”是指乙方为甲方提供的"+model.CompaneName+""+model.ProjectName+"建设项目职业病危害现状评价报告。");
            m_wordApp.Selection.TypeParagraph();
            ...
            m_wordApp.Selection.Font.Size = 14;
            m_wordApp.Selection.Font.Bold = 0;
            m_wordApp.Selection.TypeText("乙方按甲方要求，依据国家《职业病防治法》相关法律法规、标准和技术规范对"+model.CompaneName+"新建"+model.ProjectName+"建设项目职业病危害现状评价，并编制相应评价文件，形成职业病危害现状评价报告。");
            m_wordApp.Selection.TypeParagraph();
            ...
            m_wordApp.Selection.TypeParagraph();
            m_wordApp.Selection.TypeText("4	职业病防护设施及职业危害现状；");
            m_wordApp.Selection.TypeParagraph();
            ...
            m_wordApp.Selection.Font.Size = 14;
            m_wordApp.Selection.Font.Bold = 0;
            m_wordApp.Selection.TypeText("3.1甲方应于本合同签订后____日内向乙方提供本合同“附件”规定的资料。甲方应对提供资料的真实性、完整性承担责任。因甲方未能在上述时间内提供材料导致乙方工作迟延的，乙方不承担迟延履行的责任。因甲方提交的上述材料存在虚假、错误或者不完整从而导致乙方无法完成工作的，乙方有权立即终止本合同，同时要求甲方按照合同约定支付全部费用。因甲方原因造成乙方重复工作的，甲方应承担相应的费用。");
            m_wordApp.Selection.TypeParagraph();
            m_wordApp.Selection.TypeText("3.2 按合同规定向乙方支付合同价款。");
            m_wordApp.Selection.TypeParagraph();
            m_wordApp.Selection.TypeText("3.3 协助乙方完成现场职业卫生调查、检测，职业病防护设施、职业健康监护和职业卫生管理等相关资料的收集，并为乙方到现场工作提供相应的保障及便利。");
            m_wordApp.Selection.TypeParagraph();
            m_wordApp.Selection.Font.Bold = 1;
            m_wordApp.Selection.Font.Size = 16;
            ...
            m_wordApp.Selection.Font.Bold = 0;
            m_wordApp.Selection.Font.Size = 14;
            m_wordApp.Selection.TypeText("5.1 甲方将本合同约定的材料交付乙方之日起___个工作日，乙方严格按合同规定的进度计划完成职业病危害现状评价报告编制工作并将职业病危害现状评价报告的电子版交付给甲方。甲方应按照乙方通知的时间领取乙方的工作成果。甲方未按照乙方要求的时间接受工作成果的，视为甲方违约。甲方收到评价报告的电子版后应审核确认。");
            m_wordApp.Selection.TypeParagraph();
            m_wordApp.Selection.TypeText("甲方收到职业病危害现状评价报告后___日内，应组织对评价报告的内部审议工作，如认为职业病危害现状评价报告需要修改，应在上述日期内以文字的形式向乙方提出要求。甲方收到乙方提供的评价报告后____日内，未提出书面修改意见的，视为对乙方工作成果的确认。");
            m_wordApp.Selection.TypeParagraph();
            ...
            m_wordApp.Selection.TypeParagraph();
            m_wordApp.Selection.TypeText("5.5乙方向甲方提交该项目最终版的职业病危害现状评价报告一式___份。");
            m_wordApp.Selection.TypeParagraph();
            m_wordApp.Selection.Font.Bold = 1;
            m_wordApp.Selection.Font.Size = 16;
            ...
            m_wordApp.Selection.TypeParagraph();
            m_wordApp.Selection.TypeText("10.1 乙方提交的技术服务工作成果形式为编制完成的xxxx建设项目职业病危害现状评价报告书。");
            m_wordApp.Selection.TypeParagraph();
