...
namespace DKLManager.Dal
{
  ...
  //      public DbSet<UserInputList> UserInputListDB { get; set; }
        public DbSet<DeviceDetail> DeviceDetailDB { get; set; }
        public DbSet<CostingHistory> CostingHistoryDB { get; set; }
        public DbSet<Areas> AreaDB { get; set; }
        public DbSet<TimeInstructions> TimeInstructionsDB { get; set; }
        public DbSet<Costing> CostingDB { get; set; }
        public DbSet<ContractTable> ContractTableDB { get; set; }
        public DbSet<ProjectContract> ContractDB { get; set; }
        public DbSet<Cookies> CookiesDB { get; set; }
